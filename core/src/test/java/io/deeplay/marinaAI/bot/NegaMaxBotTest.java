...
class NegaMaxBotTest {
    ...
    void testCheckmateInTwoMoves() {
        ...
        Board board = new Board(getCheckmateInTwoMovesBoard());
        ...
        Move miniMaxMove2 = negaMaxBot.getMove(board, negaMaxBot.getColor());
    ...
    void testTakePiece() {
        ...
        MaterialStrategy materialStrategy = new MaterialStrategy(negaMaxBot.getColor());
    ...
    private Piece[][] getCheckmateInTwoMovesBoard() {
