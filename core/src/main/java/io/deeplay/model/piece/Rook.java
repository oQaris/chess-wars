...
public class Rook extends Piece {
    ...
    /**
     * Метод для получения возможных ходов фигуры Rook (ладья) на доске.
     *
    ...
    /**
     * Проверяет, может ли данная фигура Rook (ладья) сделать ход на заданные координаты на заданной доске.
